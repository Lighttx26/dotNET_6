...
namespace cf_preview6
{
    public partial class Form1 : Form
    {
        ...
        private void ReloadCourseCb()
        {
            ...
            cbbCourse.Items.Add(new CourseCBB
            {
                Text = "All",
                Value = "0",
            });
            cbbCourse.Items.AddRange(BLL.BLL.Instance.GetListCourse().ToArray());
            cbbCourse.SelectedIndex = 0;
        }

        private void ReloadDgv()
        {
            dgv.DataSource = BLL.BLL.Instance.GetStudentsBySearch(((CourseCBB)cbbCourse.SelectedItem).Value, tbSearch.Text);
